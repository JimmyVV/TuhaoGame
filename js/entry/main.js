...
! function() {
    ...
    }, "object" == typeof module && module.exports ? module.exports = C : "function" == typeof define && define.amd ? define('async', [], function() {
        return C
    }) : P.async = C
}();
...
require(['underscore', 'zepto', 'backbone', 'async', 'focus', 'event', 'deferred', 'callbacks', 'touch', 'utils', 'textFormat'], function(_, $, Backbone, async) {　　
    ...
    var TestView = Backbone.View.extend({
        ...
        obtainResult: function() {
            router.navigate("/result?name=" + par.get('name'), {
                trigger: true,
                replace: true
            });
        }
