...
;
define("event", ["zepto"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
;
define("deferred", ["zepto"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
;
define("callbacks", ["zepto"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
define("touch", ["zepto"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
